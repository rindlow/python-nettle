...
class Generator:
    ...
    def gen_interface_file(self, hash_list, cipher_list, ciphermode_list, 
        ...
        with open(self.python_interface, 'w', encoding='utf8') as f:
            ...
            f.write('    def from_n_e_d_p_q_a_b_c(self, n: bytes, e: bytes, d: bytes, p: bytes, q: bytes, a: bytes, b: bytes, c: bytes) -> None: ...\n')
            ...
            f.write('    def from_n_e(self, n: bytes, e: bytes) -> None: ...\n')
