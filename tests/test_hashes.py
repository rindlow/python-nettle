...
def _test(hashfunc: type[nettle.DigestableHash],
...
def _test_shake(hashfunc: type[nettle.ShakeableHash],
                msg: bytes, digest: bytes) -> None:
    h = hashfunc()
    h.update(msg)
...
def test_sha3_224() -> None:
    _test(nettle.SHA3_224, shex("4A4F202484512526"),
               shex("01386CDD70589B3B 34941EFE16B85071"
                    "E9BA948179922044 F640868E"))

def test_sha3_256() -> None:
    _test(nettle.SHA3_256, shex("4A4F202484512526"),
...
def test_shake28() -> None:
    _test_shake(nettle.SHA3_128,
...
def test_shake256() -> None:
    _test_shake(nettle.SHA3_256,
                     shex("52A608AB21CCDD8A4457A57EDE782176"),
